...
- 如果被问哪些是 Phase 2：完整记忆能力，包括 Markdown memory、long-term memory retrieval、embedding、source_ref/evidence 回源、recall/forget、replacement、Akashic-style hotness ranking、retrieval trace、context-frame injection，以及 focused Phase 2 pytest 证据。产品化 Evaluation runner 和 memory-quality 行为证明是 Phase 3。
